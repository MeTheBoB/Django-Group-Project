...
class Equipment(models.Model):
    ...
    reservation = models.ForeignKey(Reservation, on_delete=models.CASCADE, related_name='equipment', null=True)
    admin = models.ForeignKey(Admin, on_delete=models.SET_NULL, null=True, related_name='equipments')
